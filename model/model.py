...
class Model:
    ...
    def buildGraphPesato(self):
        ...
        self._grafo.clear()
        self._grafo.add_nodes_from(self._fermate)
        self.addEdgePesatiPercorrenza()

    def addEdgePesatiPercorrenza(self):
    ...
    def getEdgeWeight(self, v1, v2):
        return self._grafo[v1][v2]["weight"]  #pesodell'arcodatiduenodi
    ...
    def getBFSNodes(self, stazP):
        edges = nx.bfs_edges(self._grafo, stazP )
        visited = []
        for u,v in edges:
            visited.append(v)
        return visited

    def getDFSNodes(self, stazP):
        edges = nx.dfs_edges(self._grafo, stazP )
        visited = []
        for u,v in edges:
            visited.append(v)
        return visited
    ...
    def getTraversalTime(self, v0, v1, linea):
        ...
        vel = linea.velocita
        tempo = distanza/vel*60 #inminuti
        return tempo
    def getBestPath(self, v0, v1):  #dijkstra_path ci da solo i nodi
